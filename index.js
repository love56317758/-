...
}).prototype = getMCSymbolPrototype(lib.head, new cjs.Rectangle(-2.8,-2.8,34.7,34.7), null);
...
(lib.playButton = function(mode,startPosition,loop) {
	...
	this.text.setTransform(115.4,5.6);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.bad_guess.setTransform(916.6,48.6);
	...
	this.text = new cjs.Text("猜错", "bold 30px 'Myriad Pro'", "#C6753D");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 185;
	this.text.parent = this;
	this.text.setTransform(786.3,48.6);

	this.text_1 = new cjs.Text("猜对", "bold 30px 'Myriad Pro'", "#C6753D");
	...
	// lost
	this.lost_word = new cjs.Text("词是：", "bold 40px 'Myriad Pro'", "#242077");
	...
	this.lost_word.setTransform(645.7,251.5);

	this.text_2 = new cjs.Text("词是：", "bold 40px 'Myriad Pro'", "#C6753D");
	...
	// won
	this.text_4 = new cjs.Text("这是一个使用 HTML5 Canvas 文档创建的猜词游戏示例，可以将其发布到 HTML5。这个例子采用 Java Script 代码片段来实现交互性。", "13px 'Myriad Pro'", "#99FF99");
	this.text_4.lineHeight = 18;
	this.text_4.lineWidth = 975;
	this.text_4.parent = this;
	this.text_4.setTransform(2,-41);

	this.won_word = new cjs.Text("词是：", "bold 40px 'Myriad Pro'", "#242077");
